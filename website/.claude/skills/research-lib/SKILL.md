...
### Primary Tool: General-Purpose Subagent → Codex

Use a general-purpose subagent to delegate comprehensive library research to Codex:
...
Agent tool:
  ...
  prompt: |
    ...
    Call Codex for the latest official documentation, release notes, constraints, best practices, and known issues.
...
If Codex delegation is unavailable, verify via manual web search:
