...
- Large-scale investigation (cross-codebase analysis, web research) → delegate to Codex via `general-purpose`
...
- **Large codebase analysis** → Codex via `general-purpose`; simple codebase orientation can use an Opus subagent
- **External research and surveys** → Codex via `general-purpose`
- **Multimodal input (PDF, images, video, audio)** → Codex via `general-purpose`
- **Code implementation** → Codex via `general-purpose`, except UI/UX, animation, design, and layout work
- **Design and planning consultation** → `general-purpose` subagent → Codex
- **Simple questions and answers** → Claude can answer directly
- **Detailed analysis with long output** → `general-purpose` subagent, save to `.claude/docs/`
- **Error root cause analysis** → `codex-debugger`
- **Minor fixes (single file, small changes)** → Claude can handle directly

## Context Management (Important)

| Situation | Recommended Method |
|-----------|--------------------|
| Full codebase analysis, large scope | Codex via `general-purpose` |
| Simple codebase orientation | Opus `general-purpose` subagent |
| External research / survey | Codex via `general-purpose` |
| Multimodal files (PDF/images/video/audio) | Codex via `general-purpose` |
| Code implementation except UI/UX, animation, design, and layout | Codex via `general-purpose` |
